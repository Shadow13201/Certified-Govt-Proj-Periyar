...
import 'package:periyar_adminportal/UI%20design/bill/rangerbill.dart';
...
class HomeRanger extends StatefulWidget {
  const HomeRanger({Key? key}) : super(key: key);

  @override
  State<HomeRanger> createState() => _HomeRangerState();
}

class _HomeRangerState extends State<HomeRanger> {
  void initState(){
    super.initState();
    initFunc();
  ...
  initFunc() async{
    context.read<TokenManagerBoc>().token=await TempStorage.getToken();
  }
  @override
                        ...
                        children: [
                          ...
                          Card(
                            ...
                            child: Row(
                              children: [
                                Flexible(child: Text(
                                  "Task will be displayed with details provided by the admin.",
                                  style: TextStyle(
                                ...
                                ClipRRect(
                                  ...
                                  child: Card(color: Color(0xffFFD233),
                                    child: Text(
                                      "07", style: TextStyle(fontSize: 80,),),
  ...
  void SelectedItem(BuildContext context, item) {
    switch (item) {
      ...
      case 2:
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => rangerbill()));
        break;
